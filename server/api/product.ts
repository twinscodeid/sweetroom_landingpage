    ...
    data: [
      {
        ...
        images: ["/image/product_meja_lipat_1.jpg", "/image/product_meja_lipat_2.jpg"],
...
Tokopedia 	: Sweetroomfurni 
    ...
    images: ["/image/image_product_2.png"],
    sizes: ["M", "L", "XL"],
    colors: ["putih", "hitam", "motif kayu"],
  ...
  },
  {
    ...
    images: ["/image/image_product_3.png"],
    sizes: ["S", "M", "L"],
    colors: ["putih", "hitam", "motif kayu"],
  ...
  },
  {
    ...
    images: ["/image/image_product_1.png"],
    sizes: ["S", "M"],
    colors: ["putih", "hitam", "motif kayu"],
